  ...
  describe AdyenRedirectController do
    ...
    context "Adyen HPP Gateway" do
      ...
      it "creates a payment" do
        expect { spree_get :confirm, params }.to change { Payment.count }.by(1)
      end
    ...
    context "Adyen 3-D redirect" do
      ...
      context "stubbing Adyen API" do
        ...
        let!(:gateway) { Gateway::AdyenHPP.create!(name: "Adyen") }

        before do
          controller.stub(current_order: order)

          Gateway::AdyenHPP.stub find: gateway
